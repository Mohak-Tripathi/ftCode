...
/* device.location type struct mgos_config_device_location */
...
static inline bool mgos_config_device_location_parse(struct mg_str json, struct mgos_config_device_location *cfg) {
  mgos_config_device_location_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_device_location_get_schema(), cfg);
}
bool mgos_config_device_location_parse_f(const char *fname, struct mgos_config_device_location *cfg);
static inline bool mgos_config_device_location_emit(const struct mgos_config_device_location *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_device_location_get_schema(), pretty, out);
}
static inline bool mgos_config_device_location_emit_f(const struct mgos_config_device_location *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_device_location_get_schema(), pretty, fname);
}
static inline bool mgos_config_device_location_copy(const struct mgos_config_device_location *src, struct mgos_config_device_location *dst) {
  return mgos_conf_copy(mgos_config_device_location_get_schema(), src, dst);
}
static inline void mgos_config_device_location_free(struct mgos_config_device_location *cfg) {
  return mgos_conf_free(mgos_config_device_location_get_schema(), cfg);
}
...
/* admin type struct mgos_config_admin */
...
static inline bool mgos_config_admin_parse(struct mg_str json, struct mgos_config_admin *cfg) {
  mgos_config_admin_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_admin_get_schema(), cfg);
}
bool mgos_config_admin_parse_f(const char *fname, struct mgos_config_admin *cfg);
static inline bool mgos_config_admin_emit(const struct mgos_config_admin *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_admin_get_schema(), pretty, out);
}
static inline bool mgos_config_admin_emit_f(const struct mgos_config_admin *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_admin_get_schema(), pretty, fname);
}
static inline bool mgos_config_admin_copy(const struct mgos_config_admin *src, struct mgos_config_admin *dst) {
  return mgos_conf_copy(mgos_config_admin_get_schema(), src, dst);
}
static inline void mgos_config_admin_free(struct mgos_config_admin *cfg) {
  return mgos_conf_free(mgos_config_admin_get_schema(), cfg);
}

/* dwpc type struct mgos_config_dwpc */
struct mgos_config_dwpc {
  ...
  int sensor_freq;
  int resolution;
  int min_floor_distance;
  int max_distance_delta;
  int TotalSamplesForRangeCalibration;
  int validSamplesForRangeCalibration;
  int numberOfTargetPerZone;
  int min_consecutive_count;
  int min_signal;
  int threshold;
  int direction;
  int enable_low_confidence_target;
  int enter_or_exit_middle_ok;
  int person_count_threshold;
  int reflectance_percent;
  int nb_samples;
  int distance_mm;
};
...
static inline bool mgos_config_dwpc_parse(struct mg_str json, struct mgos_config_dwpc *cfg) {
  mgos_config_dwpc_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_dwpc_get_schema(), cfg);
}
bool mgos_config_dwpc_parse_f(const char *fname, struct mgos_config_dwpc *cfg);
static inline bool mgos_config_dwpc_emit(const struct mgos_config_dwpc *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_dwpc_get_schema(), pretty, out);
}
static inline bool mgos_config_dwpc_emit_f(const struct mgos_config_dwpc *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_dwpc_get_schema(), pretty, fname);
}
static inline bool mgos_config_dwpc_copy(const struct mgos_config_dwpc *src, struct mgos_config_dwpc *dst) {
  return mgos_conf_copy(mgos_config_dwpc_get_schema(), src, dst);
}
static inline void mgos_config_dwpc_free(struct mgos_config_dwpc *cfg) {
  return mgos_conf_free(mgos_config_dwpc_get_schema(), cfg);
}

/* service type struct mgos_config_service */
struct mgos_config_service {
  const char * xtalkcalibration_status;
  const char * livestream_toggle_status;
  const char * thresholdCalibration_status;
};
...
static inline bool mgos_config_service_parse(struct mg_str json, struct mgos_config_service *cfg) {
  mgos_config_service_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_service_get_schema(), cfg);
}
bool mgos_config_service_parse_f(const char *fname, struct mgos_config_service *cfg);
static inline bool mgos_config_service_emit(const struct mgos_config_service *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_service_get_schema(), pretty, out);
}
static inline bool mgos_config_service_emit_f(const struct mgos_config_service *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_service_get_schema(), pretty, fname);
}
static inline bool mgos_config_service_copy(const struct mgos_config_service *src, struct mgos_config_service *dst) {
  return mgos_conf_copy(mgos_config_service_get_schema(), src, dst);
}
static inline void mgos_config_service_free(struct mgos_config_service *cfg) {
  return mgos_conf_free(mgos_config_service_get_schema(), cfg);
}

/* diagnostic type struct mgos_config_diagnostic */
...
static inline bool mgos_config_diagnostic_parse(struct mg_str json, struct mgos_config_diagnostic *cfg) {
  mgos_config_diagnostic_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_diagnostic_get_schema(), cfg);
}
bool mgos_config_diagnostic_parse_f(const char *fname, struct mgos_config_diagnostic *cfg);
static inline bool mgos_config_diagnostic_emit(const struct mgos_config_diagnostic *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_diagnostic_get_schema(), pretty, out);
}
static inline bool mgos_config_diagnostic_emit_f(const struct mgos_config_diagnostic *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_diagnostic_get_schema(), pretty, fname);
}
static inline bool mgos_config_diagnostic_copy(const struct mgos_config_diagnostic *src, struct mgos_config_diagnostic *dst) {
  return mgos_conf_copy(mgos_config_diagnostic_get_schema(), src, dst);
}
static inline void mgos_config_diagnostic_free(struct mgos_config_diagnostic *cfg) {
  return mgos_conf_free(mgos_config_diagnostic_get_schema(), cfg);
}

/* pathzone type struct mgos_config_pathzone */
...
static inline bool mgos_config_pathzone_parse(struct mg_str json, struct mgos_config_pathzone *cfg) {
  mgos_config_pathzone_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_pathzone_get_schema(), cfg);
}
bool mgos_config_pathzone_parse_f(const char *fname, struct mgos_config_pathzone *cfg);
static inline bool mgos_config_pathzone_emit(const struct mgos_config_pathzone *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_pathzone_get_schema(), pretty, out);
}
static inline bool mgos_config_pathzone_emit_f(const struct mgos_config_pathzone *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_pathzone_get_schema(), pretty, fname);
}
static inline bool mgos_config_pathzone_copy(const struct mgos_config_pathzone *src, struct mgos_config_pathzone *dst) {
  return mgos_conf_copy(mgos_config_pathzone_get_schema(), src, dst);
}
static inline void mgos_config_pathzone_free(struct mgos_config_pathzone *cfg) {
  return mgos_conf_free(mgos_config_pathzone_get_schema(), cfg);
}

/* InnerOuterZone type struct mgos_config_InnerOuterZone */
...
static inline bool mgos_config_InnerOuterZone_parse(struct mg_str json, struct mgos_config_InnerOuterZone *cfg) {
  mgos_config_InnerOuterZone_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_InnerOuterZone_get_schema(), cfg);
}
bool mgos_config_InnerOuterZone_parse_f(const char *fname, struct mgos_config_InnerOuterZone *cfg);
static inline bool mgos_config_InnerOuterZone_emit(const struct mgos_config_InnerOuterZone *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_InnerOuterZone_get_schema(), pretty, out);
}
static inline bool mgos_config_InnerOuterZone_emit_f(const struct mgos_config_InnerOuterZone *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_InnerOuterZone_get_schema(), pretty, fname);
}
static inline bool mgos_config_InnerOuterZone_copy(const struct mgos_config_InnerOuterZone *src, struct mgos_config_InnerOuterZone *dst) {
  return mgos_conf_copy(mgos_config_InnerOuterZone_get_schema(), src, dst);
}
static inline void mgos_config_InnerOuterZone_free(struct mgos_config_InnerOuterZone *cfg) {
  return mgos_conf_free(mgos_config_InnerOuterZone_get_schema(), cfg);
}

/* distanceThreshold type struct mgos_config_distanceThreshold */
...
static inline bool mgos_config_distanceThreshold_parse(struct mg_str json, struct mgos_config_distanceThreshold *cfg) {
  mgos_config_distanceThreshold_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_distanceThreshold_get_schema(), cfg);
}
bool mgos_config_distanceThreshold_parse_f(const char *fname, struct mgos_config_distanceThreshold *cfg);
static inline bool mgos_config_distanceThreshold_emit(const struct mgos_config_distanceThreshold *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_distanceThreshold_get_schema(), pretty, out);
}
static inline bool mgos_config_distanceThreshold_emit_f(const struct mgos_config_distanceThreshold *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_distanceThreshold_get_schema(), pretty, fname);
}
static inline bool mgos_config_distanceThreshold_copy(const struct mgos_config_distanceThreshold *src, struct mgos_config_distanceThreshold *dst) {
  return mgos_conf_copy(mgos_config_distanceThreshold_get_schema(), src, dst);
}
static inline void mgos_config_distanceThreshold_free(struct mgos_config_distanceThreshold *cfg) {
  return mgos_conf_free(mgos_config_distanceThreshold_get_schema(), cfg);
}

/* mindistance type struct mgos_config_mindistance */
...
static inline bool mgos_config_mindistance_parse(struct mg_str json, struct mgos_config_mindistance *cfg) {
  mgos_config_mindistance_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_mindistance_get_schema(), cfg);
}
bool mgos_config_mindistance_parse_f(const char *fname, struct mgos_config_mindistance *cfg);
static inline bool mgos_config_mindistance_emit(const struct mgos_config_mindistance *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_mindistance_get_schema(), pretty, out);
}
static inline bool mgos_config_mindistance_emit_f(const struct mgos_config_mindistance *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_mindistance_get_schema(), pretty, fname);
}
static inline bool mgos_config_mindistance_copy(const struct mgos_config_mindistance *src, struct mgos_config_mindistance *dst) {
  return mgos_conf_copy(mgos_config_mindistance_get_schema(), src, dst);
}
static inline void mgos_config_mindistance_free(struct mgos_config_mindistance *cfg) {
  return mgos_conf_free(mgos_config_mindistance_get_schema(), cfg);
}
...
struct mgos_config {
  ...
  struct mgos_config_admin admin;
  struct mgos_config_dwpc dwpc;
  struct mgos_config_service service;
  struct mgos_config_diagnostic diagnostic;
  struct mgos_config_pathzone pathzone;
  struct mgos_config_InnerOuterZone InnerOuterZone;
  struct mgos_config_distanceThreshold distanceThreshold;
  struct mgos_config_mindistance mindistance;
};
...
const struct mgos_config_device_location *mgos_config_get_device_location(const struct mgos_config *cfg);
...
double mgos_config_get_device_location_lat(const struct mgos_config *cfg);
double mgos_config_get_default_device_location_lat(void);
...
static inline double mgos_sys_config_get_default_device_location_lat(void) { return mgos_config_get_default_device_location_lat(); }
...
double mgos_config_get_device_location_lon(const struct mgos_config *cfg);
double mgos_config_get_default_device_location_lon(void);
...
static inline double mgos_sys_config_get_default_device_location_lon(void) { return mgos_config_get_default_device_location_lon(); }
...
const char * mgos_config_get_mqtt_sub(const struct mgos_config *cfg);
const char * mgos_config_get_default_mqtt_sub(void);
static inline const char * mgos_sys_config_get_mqtt_sub(void) { return mgos_config_get_mqtt_sub(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_mqtt_sub(void) { return mgos_config_get_default_mqtt_sub(); }
...
/* mqtt.device_health */
#define MGOS_CONFIG_HAVE_MQTT_DEVICE_HEALTH
#define MGOS_SYS_CONFIG_HAVE_MQTT_DEVICE_HEALTH
const char * mgos_config_get_mqtt_device_health(const struct mgos_config *cfg);
const char * mgos_config_get_default_mqtt_device_health(void);
static inline const char * mgos_sys_config_get_mqtt_device_health(void) { return mgos_config_get_mqtt_device_health(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_mqtt_device_health(void) { return mgos_config_get_default_mqtt_device_health(); }
void mgos_config_set_mqtt_device_health(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_mqtt_device_health(const char * v) { mgos_config_set_mqtt_device_health(&mgos_sys_config, v); }

/* mqtt.status */
#define MGOS_CONFIG_HAVE_MQTT_STATUS
#define MGOS_SYS_CONFIG_HAVE_MQTT_STATUS
const char * mgos_config_get_mqtt_status(const struct mgos_config *cfg);
const char * mgos_config_get_default_mqtt_status(void);
static inline const char * mgos_sys_config_get_mqtt_status(void) { return mgos_config_get_mqtt_status(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_mqtt_status(void) { return mgos_config_get_default_mqtt_status(); }
void mgos_config_set_mqtt_status(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_mqtt_status(const char * v) { mgos_config_set_mqtt_status(&mgos_sys_config, v); }
...
const char * mgos_config_get_mqtt1_sub(const struct mgos_config *cfg);
const char * mgos_config_get_default_mqtt1_sub(void);
static inline const char * mgos_sys_config_get_mqtt1_sub(void) { return mgos_config_get_mqtt1_sub(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_mqtt1_sub(void) { return mgos_config_get_default_mqtt1_sub(); }
...
/* mqtt1.device_health */
#define MGOS_CONFIG_HAVE_MQTT1_DEVICE_HEALTH
#define MGOS_SYS_CONFIG_HAVE_MQTT1_DEVICE_HEALTH
const char * mgos_config_get_mqtt1_device_health(const struct mgos_config *cfg);
const char * mgos_config_get_default_mqtt1_device_health(void);
static inline const char * mgos_sys_config_get_mqtt1_device_health(void) { return mgos_config_get_mqtt1_device_health(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_mqtt1_device_health(void) { return mgos_config_get_default_mqtt1_device_health(); }
void mgos_config_set_mqtt1_device_health(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_mqtt1_device_health(const char * v) { mgos_config_set_mqtt1_device_health(&mgos_sys_config, v); }

/* mqtt1.status */
#define MGOS_CONFIG_HAVE_MQTT1_STATUS
#define MGOS_SYS_CONFIG_HAVE_MQTT1_STATUS
const char * mgos_config_get_mqtt1_status(const struct mgos_config *cfg);
const char * mgos_config_get_default_mqtt1_status(void);
static inline const char * mgos_sys_config_get_mqtt1_status(void) { return mgos_config_get_mqtt1_status(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_mqtt1_status(void) { return mgos_config_get_default_mqtt1_status(); }
void mgos_config_set_mqtt1_status(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_mqtt1_status(const char * v) { mgos_config_set_mqtt1_status(&mgos_sys_config, v); }
...
/* admin */
#define MGOS_CONFIG_HAVE_ADMIN
#define MGOS_SYS_CONFIG_HAVE_ADMIN
const struct mgos_config_admin *mgos_config_get_admin(const struct mgos_config *cfg);
static inline const struct mgos_config_admin *mgos_sys_config_get_admin(void) { return mgos_config_get_admin(&mgos_sys_config); }

/* admin.variant */
#define MGOS_CONFIG_HAVE_ADMIN_VARIANT
#define MGOS_SYS_CONFIG_HAVE_ADMIN_VARIANT
const char * mgos_config_get_admin_variant(const struct mgos_config *cfg);
const char * mgos_config_get_default_admin_variant(void);
static inline const char * mgos_sys_config_get_admin_variant(void) { return mgos_config_get_admin_variant(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_admin_variant(void) { return mgos_config_get_default_admin_variant(); }
void mgos_config_set_admin_variant(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_admin_variant(const char * v) { mgos_config_set_admin_variant(&mgos_sys_config, v); }

/* admin.version */
#define MGOS_CONFIG_HAVE_ADMIN_VERSION
#define MGOS_SYS_CONFIG_HAVE_ADMIN_VERSION
const char * mgos_config_get_admin_version(const struct mgos_config *cfg);
const char * mgos_config_get_default_admin_version(void);
static inline const char * mgos_sys_config_get_admin_version(void) { return mgos_config_get_admin_version(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_admin_version(void) { return mgos_config_get_default_admin_version(); }
void mgos_config_set_admin_version(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_admin_version(const char * v) { mgos_config_set_admin_version(&mgos_sys_config, v); }

/* dwpc */
#define MGOS_CONFIG_HAVE_DWPC
#define MGOS_SYS_CONFIG_HAVE_DWPC
const struct mgos_config_dwpc *mgos_config_get_dwpc(const struct mgos_config *cfg);
static inline const struct mgos_config_dwpc *mgos_sys_config_get_dwpc(void) { return mgos_config_get_dwpc(&mgos_sys_config); }

/* dwpc.interval */
#define MGOS_CONFIG_HAVE_DWPC_INTERVAL
#define MGOS_SYS_CONFIG_HAVE_DWPC_INTERVAL
int mgos_config_get_dwpc_interval(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_interval(void);
static inline int mgos_sys_config_get_dwpc_interval(void) { return mgos_config_get_dwpc_interval(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_interval(void) { return mgos_config_get_default_dwpc_interval(); }
void mgos_config_set_dwpc_interval(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_interval(int v) { mgos_config_set_dwpc_interval(&mgos_sys_config, v); }

/* dwpc.function_mode */
#define MGOS_CONFIG_HAVE_DWPC_FUNCTION_MODE
#define MGOS_SYS_CONFIG_HAVE_DWPC_FUNCTION_MODE
int mgos_config_get_dwpc_function_mode(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_function_mode(void);
static inline int mgos_sys_config_get_dwpc_function_mode(void) { return mgos_config_get_dwpc_function_mode(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_function_mode(void) { return mgos_config_get_default_dwpc_function_mode(); }
void mgos_config_set_dwpc_function_mode(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_function_mode(int v) { mgos_config_set_dwpc_function_mode(&mgos_sys_config, v); }

/* dwpc.periodic_reset */
#define MGOS_CONFIG_HAVE_DWPC_PERIODIC_RESET
#define MGOS_SYS_CONFIG_HAVE_DWPC_PERIODIC_RESET
int mgos_config_get_dwpc_periodic_reset(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_periodic_reset(void);
static inline int mgos_sys_config_get_dwpc_periodic_reset(void) { return mgos_config_get_dwpc_periodic_reset(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_periodic_reset(void) { return mgos_config_get_default_dwpc_periodic_reset(); }
void mgos_config_set_dwpc_periodic_reset(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_periodic_reset(int v) { mgos_config_set_dwpc_periodic_reset(&mgos_sys_config, v); }

/* dwpc.capacity */
#define MGOS_CONFIG_HAVE_DWPC_CAPACITY
#define MGOS_SYS_CONFIG_HAVE_DWPC_CAPACITY
int mgos_config_get_dwpc_capacity(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_capacity(void);
static inline int mgos_sys_config_get_dwpc_capacity(void) { return mgos_config_get_dwpc_capacity(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_capacity(void) { return mgos_config_get_default_dwpc_capacity(); }
void mgos_config_set_dwpc_capacity(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_capacity(int v) { mgos_config_set_dwpc_capacity(&mgos_sys_config, v); }

/* dwpc.sensor_freq */
#define MGOS_CONFIG_HAVE_DWPC_SENSOR_FREQ
#define MGOS_SYS_CONFIG_HAVE_DWPC_SENSOR_FREQ
int mgos_config_get_dwpc_sensor_freq(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_sensor_freq(void);
static inline int mgos_sys_config_get_dwpc_sensor_freq(void) { return mgos_config_get_dwpc_sensor_freq(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_sensor_freq(void) { return mgos_config_get_default_dwpc_sensor_freq(); }
void mgos_config_set_dwpc_sensor_freq(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_sensor_freq(int v) { mgos_config_set_dwpc_sensor_freq(&mgos_sys_config, v); }

/* dwpc.resolution */
#define MGOS_CONFIG_HAVE_DWPC_RESOLUTION
#define MGOS_SYS_CONFIG_HAVE_DWPC_RESOLUTION
int mgos_config_get_dwpc_resolution(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_resolution(void);
static inline int mgos_sys_config_get_dwpc_resolution(void) { return mgos_config_get_dwpc_resolution(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_resolution(void) { return mgos_config_get_default_dwpc_resolution(); }
void mgos_config_set_dwpc_resolution(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_resolution(int v) { mgos_config_set_dwpc_resolution(&mgos_sys_config, v); }

/* dwpc.min_floor_distance */
#define MGOS_CONFIG_HAVE_DWPC_MIN_FLOOR_DISTANCE
#define MGOS_SYS_CONFIG_HAVE_DWPC_MIN_FLOOR_DISTANCE
int mgos_config_get_dwpc_min_floor_distance(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_min_floor_distance(void);
static inline int mgos_sys_config_get_dwpc_min_floor_distance(void) { return mgos_config_get_dwpc_min_floor_distance(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_min_floor_distance(void) { return mgos_config_get_default_dwpc_min_floor_distance(); }
void mgos_config_set_dwpc_min_floor_distance(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_min_floor_distance(int v) { mgos_config_set_dwpc_min_floor_distance(&mgos_sys_config, v); }

/* dwpc.max_distance_delta */
#define MGOS_CONFIG_HAVE_DWPC_MAX_DISTANCE_DELTA
#define MGOS_SYS_CONFIG_HAVE_DWPC_MAX_DISTANCE_DELTA
int mgos_config_get_dwpc_max_distance_delta(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_max_distance_delta(void);
static inline int mgos_sys_config_get_dwpc_max_distance_delta(void) { return mgos_config_get_dwpc_max_distance_delta(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_max_distance_delta(void) { return mgos_config_get_default_dwpc_max_distance_delta(); }
void mgos_config_set_dwpc_max_distance_delta(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_max_distance_delta(int v) { mgos_config_set_dwpc_max_distance_delta(&mgos_sys_config, v); }

/* dwpc.TotalSamplesForRangeCalibration */
#define MGOS_CONFIG_HAVE_DWPC_TOTALSAMPLESFORRANGECALIBRATION
#define MGOS_SYS_CONFIG_HAVE_DWPC_TOTALSAMPLESFORRANGECALIBRATION
int mgos_config_get_dwpc_TotalSamplesForRangeCalibration(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_TotalSamplesForRangeCalibration(void);
static inline int mgos_sys_config_get_dwpc_TotalSamplesForRangeCalibration(void) { return mgos_config_get_dwpc_TotalSamplesForRangeCalibration(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_TotalSamplesForRangeCalibration(void) { return mgos_config_get_default_dwpc_TotalSamplesForRangeCalibration(); }
void mgos_config_set_dwpc_TotalSamplesForRangeCalibration(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_TotalSamplesForRangeCalibration(int v) { mgos_config_set_dwpc_TotalSamplesForRangeCalibration(&mgos_sys_config, v); }

/* dwpc.validSamplesForRangeCalibration */
#define MGOS_CONFIG_HAVE_DWPC_VALIDSAMPLESFORRANGECALIBRATION
#define MGOS_SYS_CONFIG_HAVE_DWPC_VALIDSAMPLESFORRANGECALIBRATION
int mgos_config_get_dwpc_validSamplesForRangeCalibration(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_validSamplesForRangeCalibration(void);
static inline int mgos_sys_config_get_dwpc_validSamplesForRangeCalibration(void) { return mgos_config_get_dwpc_validSamplesForRangeCalibration(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_validSamplesForRangeCalibration(void) { return mgos_config_get_default_dwpc_validSamplesForRangeCalibration(); }
void mgos_config_set_dwpc_validSamplesForRangeCalibration(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_validSamplesForRangeCalibration(int v) { mgos_config_set_dwpc_validSamplesForRangeCalibration(&mgos_sys_config, v); }

/* dwpc.numberOfTargetPerZone */
#define MGOS_CONFIG_HAVE_DWPC_NUMBEROFTARGETPERZONE
#define MGOS_SYS_CONFIG_HAVE_DWPC_NUMBEROFTARGETPERZONE
int mgos_config_get_dwpc_numberOfTargetPerZone(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_numberOfTargetPerZone(void);
static inline int mgos_sys_config_get_dwpc_numberOfTargetPerZone(void) { return mgos_config_get_dwpc_numberOfTargetPerZone(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_numberOfTargetPerZone(void) { return mgos_config_get_default_dwpc_numberOfTargetPerZone(); }
void mgos_config_set_dwpc_numberOfTargetPerZone(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_numberOfTargetPerZone(int v) { mgos_config_set_dwpc_numberOfTargetPerZone(&mgos_sys_config, v); }

/* dwpc.min_consecutive_count */
#define MGOS_CONFIG_HAVE_DWPC_MIN_CONSECUTIVE_COUNT
#define MGOS_SYS_CONFIG_HAVE_DWPC_MIN_CONSECUTIVE_COUNT
int mgos_config_get_dwpc_min_consecutive_count(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_min_consecutive_count(void);
static inline int mgos_sys_config_get_dwpc_min_consecutive_count(void) { return mgos_config_get_dwpc_min_consecutive_count(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_min_consecutive_count(void) { return mgos_config_get_default_dwpc_min_consecutive_count(); }
void mgos_config_set_dwpc_min_consecutive_count(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_min_consecutive_count(int v) { mgos_config_set_dwpc_min_consecutive_count(&mgos_sys_config, v); }

/* dwpc.min_signal */
#define MGOS_CONFIG_HAVE_DWPC_MIN_SIGNAL
#define MGOS_SYS_CONFIG_HAVE_DWPC_MIN_SIGNAL
int mgos_config_get_dwpc_min_signal(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_min_signal(void);
static inline int mgos_sys_config_get_dwpc_min_signal(void) { return mgos_config_get_dwpc_min_signal(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_min_signal(void) { return mgos_config_get_default_dwpc_min_signal(); }
void mgos_config_set_dwpc_min_signal(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_min_signal(int v) { mgos_config_set_dwpc_min_signal(&mgos_sys_config, v); }

/* dwpc.threshold */
#define MGOS_CONFIG_HAVE_DWPC_THRESHOLD
#define MGOS_SYS_CONFIG_HAVE_DWPC_THRESHOLD
int mgos_config_get_dwpc_threshold(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_threshold(void);
static inline int mgos_sys_config_get_dwpc_threshold(void) { return mgos_config_get_dwpc_threshold(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_threshold(void) { return mgos_config_get_default_dwpc_threshold(); }
void mgos_config_set_dwpc_threshold(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_threshold(int v) { mgos_config_set_dwpc_threshold(&mgos_sys_config, v); }

/* dwpc.direction */
#define MGOS_CONFIG_HAVE_DWPC_DIRECTION
#define MGOS_SYS_CONFIG_HAVE_DWPC_DIRECTION
int mgos_config_get_dwpc_direction(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_direction(void);
static inline int mgos_sys_config_get_dwpc_direction(void) { return mgos_config_get_dwpc_direction(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_direction(void) { return mgos_config_get_default_dwpc_direction(); }
void mgos_config_set_dwpc_direction(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_direction(int v) { mgos_config_set_dwpc_direction(&mgos_sys_config, v); }

/* dwpc.enable_low_confidence_target */
#define MGOS_CONFIG_HAVE_DWPC_ENABLE_LOW_CONFIDENCE_TARGET
#define MGOS_SYS_CONFIG_HAVE_DWPC_ENABLE_LOW_CONFIDENCE_TARGET
int mgos_config_get_dwpc_enable_low_confidence_target(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_enable_low_confidence_target(void);
static inline int mgos_sys_config_get_dwpc_enable_low_confidence_target(void) { return mgos_config_get_dwpc_enable_low_confidence_target(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_enable_low_confidence_target(void) { return mgos_config_get_default_dwpc_enable_low_confidence_target(); }
void mgos_config_set_dwpc_enable_low_confidence_target(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_enable_low_confidence_target(int v) { mgos_config_set_dwpc_enable_low_confidence_target(&mgos_sys_config, v); }

/* dwpc.enter_or_exit_middle_ok */
#define MGOS_CONFIG_HAVE_DWPC_ENTER_OR_EXIT_MIDDLE_OK
#define MGOS_SYS_CONFIG_HAVE_DWPC_ENTER_OR_EXIT_MIDDLE_OK
int mgos_config_get_dwpc_enter_or_exit_middle_ok(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_enter_or_exit_middle_ok(void);
static inline int mgos_sys_config_get_dwpc_enter_or_exit_middle_ok(void) { return mgos_config_get_dwpc_enter_or_exit_middle_ok(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_enter_or_exit_middle_ok(void) { return mgos_config_get_default_dwpc_enter_or_exit_middle_ok(); }
void mgos_config_set_dwpc_enter_or_exit_middle_ok(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_enter_or_exit_middle_ok(int v) { mgos_config_set_dwpc_enter_or_exit_middle_ok(&mgos_sys_config, v); }

/* dwpc.person_count_threshold */
#define MGOS_CONFIG_HAVE_DWPC_PERSON_COUNT_THRESHOLD
#define MGOS_SYS_CONFIG_HAVE_DWPC_PERSON_COUNT_THRESHOLD
int mgos_config_get_dwpc_person_count_threshold(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_person_count_threshold(void);
static inline int mgos_sys_config_get_dwpc_person_count_threshold(void) { return mgos_config_get_dwpc_person_count_threshold(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_person_count_threshold(void) { return mgos_config_get_default_dwpc_person_count_threshold(); }
void mgos_config_set_dwpc_person_count_threshold(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_person_count_threshold(int v) { mgos_config_set_dwpc_person_count_threshold(&mgos_sys_config, v); }

/* dwpc.reflectance_percent */
#define MGOS_CONFIG_HAVE_DWPC_REFLECTANCE_PERCENT
#define MGOS_SYS_CONFIG_HAVE_DWPC_REFLECTANCE_PERCENT
int mgos_config_get_dwpc_reflectance_percent(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_reflectance_percent(void);
static inline int mgos_sys_config_get_dwpc_reflectance_percent(void) { return mgos_config_get_dwpc_reflectance_percent(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_reflectance_percent(void) { return mgos_config_get_default_dwpc_reflectance_percent(); }
void mgos_config_set_dwpc_reflectance_percent(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_reflectance_percent(int v) { mgos_config_set_dwpc_reflectance_percent(&mgos_sys_config, v); }

/* dwpc.nb_samples */
#define MGOS_CONFIG_HAVE_DWPC_NB_SAMPLES
#define MGOS_SYS_CONFIG_HAVE_DWPC_NB_SAMPLES
int mgos_config_get_dwpc_nb_samples(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_nb_samples(void);
static inline int mgos_sys_config_get_dwpc_nb_samples(void) { return mgos_config_get_dwpc_nb_samples(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_nb_samples(void) { return mgos_config_get_default_dwpc_nb_samples(); }
void mgos_config_set_dwpc_nb_samples(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_nb_samples(int v) { mgos_config_set_dwpc_nb_samples(&mgos_sys_config, v); }

/* dwpc.distance_mm */
#define MGOS_CONFIG_HAVE_DWPC_DISTANCE_MM
#define MGOS_SYS_CONFIG_HAVE_DWPC_DISTANCE_MM
int mgos_config_get_dwpc_distance_mm(const struct mgos_config *cfg);
int mgos_config_get_default_dwpc_distance_mm(void);
static inline int mgos_sys_config_get_dwpc_distance_mm(void) { return mgos_config_get_dwpc_distance_mm(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_dwpc_distance_mm(void) { return mgos_config_get_default_dwpc_distance_mm(); }
void mgos_config_set_dwpc_distance_mm(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_dwpc_distance_mm(int v) { mgos_config_set_dwpc_distance_mm(&mgos_sys_config, v); }

/* service */
#define MGOS_CONFIG_HAVE_SERVICE
#define MGOS_SYS_CONFIG_HAVE_SERVICE
const struct mgos_config_service *mgos_config_get_service(const struct mgos_config *cfg);
static inline const struct mgos_config_service *mgos_sys_config_get_service(void) { return mgos_config_get_service(&mgos_sys_config); }

/* service.xtalkcalibration_status */
#define MGOS_CONFIG_HAVE_SERVICE_XTALKCALIBRATION_STATUS
#define MGOS_SYS_CONFIG_HAVE_SERVICE_XTALKCALIBRATION_STATUS
const char * mgos_config_get_service_xtalkcalibration_status(const struct mgos_config *cfg);
const char * mgos_config_get_default_service_xtalkcalibration_status(void);
static inline const char * mgos_sys_config_get_service_xtalkcalibration_status(void) { return mgos_config_get_service_xtalkcalibration_status(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_service_xtalkcalibration_status(void) { return mgos_config_get_default_service_xtalkcalibration_status(); }
void mgos_config_set_service_xtalkcalibration_status(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_service_xtalkcalibration_status(const char * v) { mgos_config_set_service_xtalkcalibration_status(&mgos_sys_config, v); }

/* service.livestream_toggle_status */
#define MGOS_CONFIG_HAVE_SERVICE_LIVESTREAM_TOGGLE_STATUS
#define MGOS_SYS_CONFIG_HAVE_SERVICE_LIVESTREAM_TOGGLE_STATUS
const char * mgos_config_get_service_livestream_toggle_status(const struct mgos_config *cfg);
const char * mgos_config_get_default_service_livestream_toggle_status(void);
static inline const char * mgos_sys_config_get_service_livestream_toggle_status(void) { return mgos_config_get_service_livestream_toggle_status(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_service_livestream_toggle_status(void) { return mgos_config_get_default_service_livestream_toggle_status(); }
void mgos_config_set_service_livestream_toggle_status(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_service_livestream_toggle_status(const char * v) { mgos_config_set_service_livestream_toggle_status(&mgos_sys_config, v); }

/* service.thresholdCalibration_status */
#define MGOS_CONFIG_HAVE_SERVICE_THRESHOLDCALIBRATION_STATUS
#define MGOS_SYS_CONFIG_HAVE_SERVICE_THRESHOLDCALIBRATION_STATUS
const char * mgos_config_get_service_thresholdCalibration_status(const struct mgos_config *cfg);
const char * mgos_config_get_default_service_thresholdCalibration_status(void);
static inline const char * mgos_sys_config_get_service_thresholdCalibration_status(void) { return mgos_config_get_service_thresholdCalibration_status(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_service_thresholdCalibration_status(void) { return mgos_config_get_default_service_thresholdCalibration_status(); }
void mgos_config_set_service_thresholdCalibration_status(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_service_thresholdCalibration_status(const char * v) { mgos_config_set_service_thresholdCalibration_status(&mgos_sys_config, v); }

/* diagnostic */
#define MGOS_CONFIG_HAVE_DIAGNOSTIC
#define MGOS_SYS_CONFIG_HAVE_DIAGNOSTIC
const struct mgos_config_diagnostic *mgos_config_get_diagnostic(const struct mgos_config *cfg);
static inline const struct mgos_config_diagnostic *mgos_sys_config_get_diagnostic(void) { return mgos_config_get_diagnostic(&mgos_sys_config); }

/* diagnostic.topic */
#define MGOS_CONFIG_HAVE_DIAGNOSTIC_TOPIC
#define MGOS_SYS_CONFIG_HAVE_DIAGNOSTIC_TOPIC
const char * mgos_config_get_diagnostic_topic(const struct mgos_config *cfg);
const char * mgos_config_get_default_diagnostic_topic(void);
static inline const char * mgos_sys_config_get_diagnostic_topic(void) { return mgos_config_get_diagnostic_topic(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_diagnostic_topic(void) { return mgos_config_get_default_diagnostic_topic(); }
void mgos_config_set_diagnostic_topic(struct mgos_config *cfg, const char * v);
static inline void mgos_sys_config_set_diagnostic_topic(const char * v) { mgos_config_set_diagnostic_topic(&mgos_sys_config, v); }

/* pathzone */
#define MGOS_CONFIG_HAVE_PATHZONE
#define MGOS_SYS_CONFIG_HAVE_PATHZONE
const struct mgos_config_pathzone *mgos_config_get_pathzone(const struct mgos_config *cfg);
static inline const struct mgos_config_pathzone *mgos_sys_config_get_pathzone(void) { return mgos_config_get_pathzone(&mgos_sys_config); }

/* pathzone.index0 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX0
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX0
int mgos_config_get_pathzone_index0(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index0(void);
static inline int mgos_sys_config_get_pathzone_index0(void) { return mgos_config_get_pathzone_index0(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index0(void) { return mgos_config_get_default_pathzone_index0(); }
void mgos_config_set_pathzone_index0(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index0(int v) { mgos_config_set_pathzone_index0(&mgos_sys_config, v); }

/* pathzone.index1 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX1
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX1
int mgos_config_get_pathzone_index1(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index1(void);
static inline int mgos_sys_config_get_pathzone_index1(void) { return mgos_config_get_pathzone_index1(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index1(void) { return mgos_config_get_default_pathzone_index1(); }
void mgos_config_set_pathzone_index1(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index1(int v) { mgos_config_set_pathzone_index1(&mgos_sys_config, v); }

/* pathzone.index2 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX2
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX2
int mgos_config_get_pathzone_index2(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index2(void);
static inline int mgos_sys_config_get_pathzone_index2(void) { return mgos_config_get_pathzone_index2(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index2(void) { return mgos_config_get_default_pathzone_index2(); }
void mgos_config_set_pathzone_index2(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index2(int v) { mgos_config_set_pathzone_index2(&mgos_sys_config, v); }

/* pathzone.index3 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX3
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX3
int mgos_config_get_pathzone_index3(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index3(void);
static inline int mgos_sys_config_get_pathzone_index3(void) { return mgos_config_get_pathzone_index3(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index3(void) { return mgos_config_get_default_pathzone_index3(); }
void mgos_config_set_pathzone_index3(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index3(int v) { mgos_config_set_pathzone_index3(&mgos_sys_config, v); }

/* pathzone.index4 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX4
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX4
int mgos_config_get_pathzone_index4(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index4(void);
static inline int mgos_sys_config_get_pathzone_index4(void) { return mgos_config_get_pathzone_index4(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index4(void) { return mgos_config_get_default_pathzone_index4(); }
void mgos_config_set_pathzone_index4(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index4(int v) { mgos_config_set_pathzone_index4(&mgos_sys_config, v); }

/* pathzone.index5 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX5
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX5
int mgos_config_get_pathzone_index5(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index5(void);
static inline int mgos_sys_config_get_pathzone_index5(void) { return mgos_config_get_pathzone_index5(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index5(void) { return mgos_config_get_default_pathzone_index5(); }
void mgos_config_set_pathzone_index5(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index5(int v) { mgos_config_set_pathzone_index5(&mgos_sys_config, v); }

/* pathzone.index6 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX6
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX6
int mgos_config_get_pathzone_index6(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index6(void);
static inline int mgos_sys_config_get_pathzone_index6(void) { return mgos_config_get_pathzone_index6(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index6(void) { return mgos_config_get_default_pathzone_index6(); }
void mgos_config_set_pathzone_index6(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index6(int v) { mgos_config_set_pathzone_index6(&mgos_sys_config, v); }

/* pathzone.index7 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX7
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX7
int mgos_config_get_pathzone_index7(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index7(void);
static inline int mgos_sys_config_get_pathzone_index7(void) { return mgos_config_get_pathzone_index7(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index7(void) { return mgos_config_get_default_pathzone_index7(); }
void mgos_config_set_pathzone_index7(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index7(int v) { mgos_config_set_pathzone_index7(&mgos_sys_config, v); }

/* pathzone.index8 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX8
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX8
int mgos_config_get_pathzone_index8(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index8(void);
static inline int mgos_sys_config_get_pathzone_index8(void) { return mgos_config_get_pathzone_index8(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index8(void) { return mgos_config_get_default_pathzone_index8(); }
void mgos_config_set_pathzone_index8(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index8(int v) { mgos_config_set_pathzone_index8(&mgos_sys_config, v); }

/* pathzone.index9 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX9
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX9
int mgos_config_get_pathzone_index9(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index9(void);
static inline int mgos_sys_config_get_pathzone_index9(void) { return mgos_config_get_pathzone_index9(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index9(void) { return mgos_config_get_default_pathzone_index9(); }
void mgos_config_set_pathzone_index9(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index9(int v) { mgos_config_set_pathzone_index9(&mgos_sys_config, v); }

/* pathzone.index10 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX10
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX10
int mgos_config_get_pathzone_index10(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index10(void);
static inline int mgos_sys_config_get_pathzone_index10(void) { return mgos_config_get_pathzone_index10(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index10(void) { return mgos_config_get_default_pathzone_index10(); }
void mgos_config_set_pathzone_index10(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index10(int v) { mgos_config_set_pathzone_index10(&mgos_sys_config, v); }

/* pathzone.index11 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX11
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX11
int mgos_config_get_pathzone_index11(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index11(void);
static inline int mgos_sys_config_get_pathzone_index11(void) { return mgos_config_get_pathzone_index11(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index11(void) { return mgos_config_get_default_pathzone_index11(); }
void mgos_config_set_pathzone_index11(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index11(int v) { mgos_config_set_pathzone_index11(&mgos_sys_config, v); }

/* pathzone.index12 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX12
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX12
int mgos_config_get_pathzone_index12(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index12(void);
static inline int mgos_sys_config_get_pathzone_index12(void) { return mgos_config_get_pathzone_index12(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index12(void) { return mgos_config_get_default_pathzone_index12(); }
void mgos_config_set_pathzone_index12(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index12(int v) { mgos_config_set_pathzone_index12(&mgos_sys_config, v); }

/* pathzone.index13 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX13
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX13
int mgos_config_get_pathzone_index13(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index13(void);
static inline int mgos_sys_config_get_pathzone_index13(void) { return mgos_config_get_pathzone_index13(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index13(void) { return mgos_config_get_default_pathzone_index13(); }
void mgos_config_set_pathzone_index13(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index13(int v) { mgos_config_set_pathzone_index13(&mgos_sys_config, v); }

/* pathzone.index14 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX14
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX14
int mgos_config_get_pathzone_index14(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index14(void);
static inline int mgos_sys_config_get_pathzone_index14(void) { return mgos_config_get_pathzone_index14(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index14(void) { return mgos_config_get_default_pathzone_index14(); }
void mgos_config_set_pathzone_index14(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index14(int v) { mgos_config_set_pathzone_index14(&mgos_sys_config, v); }

/* pathzone.index15 */
#define MGOS_CONFIG_HAVE_PATHZONE_INDEX15
#define MGOS_SYS_CONFIG_HAVE_PATHZONE_INDEX15
int mgos_config_get_pathzone_index15(const struct mgos_config *cfg);
int mgos_config_get_default_pathzone_index15(void);
static inline int mgos_sys_config_get_pathzone_index15(void) { return mgos_config_get_pathzone_index15(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_pathzone_index15(void) { return mgos_config_get_default_pathzone_index15(); }
void mgos_config_set_pathzone_index15(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_pathzone_index15(int v) { mgos_config_set_pathzone_index15(&mgos_sys_config, v); }

/* InnerOuterZone */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE
const struct mgos_config_InnerOuterZone *mgos_config_get_InnerOuterZone(const struct mgos_config *cfg);
static inline const struct mgos_config_InnerOuterZone *mgos_sys_config_get_InnerOuterZone(void) { return mgos_config_get_InnerOuterZone(&mgos_sys_config); }

/* InnerOuterZone.index0 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX0
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX0
int mgos_config_get_InnerOuterZone_index0(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index0(void);
static inline int mgos_sys_config_get_InnerOuterZone_index0(void) { return mgos_config_get_InnerOuterZone_index0(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index0(void) { return mgos_config_get_default_InnerOuterZone_index0(); }
void mgos_config_set_InnerOuterZone_index0(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index0(int v) { mgos_config_set_InnerOuterZone_index0(&mgos_sys_config, v); }

/* InnerOuterZone.index1 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX1
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX1
int mgos_config_get_InnerOuterZone_index1(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index1(void);
static inline int mgos_sys_config_get_InnerOuterZone_index1(void) { return mgos_config_get_InnerOuterZone_index1(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index1(void) { return mgos_config_get_default_InnerOuterZone_index1(); }
void mgos_config_set_InnerOuterZone_index1(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index1(int v) { mgos_config_set_InnerOuterZone_index1(&mgos_sys_config, v); }

/* InnerOuterZone.index2 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX2
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX2
int mgos_config_get_InnerOuterZone_index2(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index2(void);
static inline int mgos_sys_config_get_InnerOuterZone_index2(void) { return mgos_config_get_InnerOuterZone_index2(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index2(void) { return mgos_config_get_default_InnerOuterZone_index2(); }
void mgos_config_set_InnerOuterZone_index2(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index2(int v) { mgos_config_set_InnerOuterZone_index2(&mgos_sys_config, v); }

/* InnerOuterZone.index3 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX3
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX3
int mgos_config_get_InnerOuterZone_index3(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index3(void);
static inline int mgos_sys_config_get_InnerOuterZone_index3(void) { return mgos_config_get_InnerOuterZone_index3(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index3(void) { return mgos_config_get_default_InnerOuterZone_index3(); }
void mgos_config_set_InnerOuterZone_index3(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index3(int v) { mgos_config_set_InnerOuterZone_index3(&mgos_sys_config, v); }

/* InnerOuterZone.index4 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX4
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX4
int mgos_config_get_InnerOuterZone_index4(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index4(void);
static inline int mgos_sys_config_get_InnerOuterZone_index4(void) { return mgos_config_get_InnerOuterZone_index4(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index4(void) { return mgos_config_get_default_InnerOuterZone_index4(); }
void mgos_config_set_InnerOuterZone_index4(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index4(int v) { mgos_config_set_InnerOuterZone_index4(&mgos_sys_config, v); }

/* InnerOuterZone.index5 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX5
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX5
int mgos_config_get_InnerOuterZone_index5(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index5(void);
static inline int mgos_sys_config_get_InnerOuterZone_index5(void) { return mgos_config_get_InnerOuterZone_index5(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index5(void) { return mgos_config_get_default_InnerOuterZone_index5(); }
void mgos_config_set_InnerOuterZone_index5(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index5(int v) { mgos_config_set_InnerOuterZone_index5(&mgos_sys_config, v); }

/* InnerOuterZone.index6 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX6
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX6
int mgos_config_get_InnerOuterZone_index6(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index6(void);
static inline int mgos_sys_config_get_InnerOuterZone_index6(void) { return mgos_config_get_InnerOuterZone_index6(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index6(void) { return mgos_config_get_default_InnerOuterZone_index6(); }
void mgos_config_set_InnerOuterZone_index6(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index6(int v) { mgos_config_set_InnerOuterZone_index6(&mgos_sys_config, v); }

/* InnerOuterZone.index7 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX7
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX7
int mgos_config_get_InnerOuterZone_index7(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index7(void);
static inline int mgos_sys_config_get_InnerOuterZone_index7(void) { return mgos_config_get_InnerOuterZone_index7(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index7(void) { return mgos_config_get_default_InnerOuterZone_index7(); }
void mgos_config_set_InnerOuterZone_index7(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index7(int v) { mgos_config_set_InnerOuterZone_index7(&mgos_sys_config, v); }

/* InnerOuterZone.index8 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX8
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX8
int mgos_config_get_InnerOuterZone_index8(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index8(void);
static inline int mgos_sys_config_get_InnerOuterZone_index8(void) { return mgos_config_get_InnerOuterZone_index8(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index8(void) { return mgos_config_get_default_InnerOuterZone_index8(); }
void mgos_config_set_InnerOuterZone_index8(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index8(int v) { mgos_config_set_InnerOuterZone_index8(&mgos_sys_config, v); }

/* InnerOuterZone.index9 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX9
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX9
int mgos_config_get_InnerOuterZone_index9(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index9(void);
static inline int mgos_sys_config_get_InnerOuterZone_index9(void) { return mgos_config_get_InnerOuterZone_index9(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index9(void) { return mgos_config_get_default_InnerOuterZone_index9(); }
void mgos_config_set_InnerOuterZone_index9(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index9(int v) { mgos_config_set_InnerOuterZone_index9(&mgos_sys_config, v); }

/* InnerOuterZone.index10 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX10
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX10
int mgos_config_get_InnerOuterZone_index10(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index10(void);
static inline int mgos_sys_config_get_InnerOuterZone_index10(void) { return mgos_config_get_InnerOuterZone_index10(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index10(void) { return mgos_config_get_default_InnerOuterZone_index10(); }
void mgos_config_set_InnerOuterZone_index10(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index10(int v) { mgos_config_set_InnerOuterZone_index10(&mgos_sys_config, v); }

/* InnerOuterZone.index11 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX11
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX11
int mgos_config_get_InnerOuterZone_index11(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index11(void);
static inline int mgos_sys_config_get_InnerOuterZone_index11(void) { return mgos_config_get_InnerOuterZone_index11(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index11(void) { return mgos_config_get_default_InnerOuterZone_index11(); }
void mgos_config_set_InnerOuterZone_index11(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index11(int v) { mgos_config_set_InnerOuterZone_index11(&mgos_sys_config, v); }

/* InnerOuterZone.index12 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX12
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX12
int mgos_config_get_InnerOuterZone_index12(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index12(void);
static inline int mgos_sys_config_get_InnerOuterZone_index12(void) { return mgos_config_get_InnerOuterZone_index12(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index12(void) { return mgos_config_get_default_InnerOuterZone_index12(); }
void mgos_config_set_InnerOuterZone_index12(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index12(int v) { mgos_config_set_InnerOuterZone_index12(&mgos_sys_config, v); }

/* InnerOuterZone.index13 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX13
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX13
int mgos_config_get_InnerOuterZone_index13(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index13(void);
static inline int mgos_sys_config_get_InnerOuterZone_index13(void) { return mgos_config_get_InnerOuterZone_index13(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index13(void) { return mgos_config_get_default_InnerOuterZone_index13(); }
void mgos_config_set_InnerOuterZone_index13(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index13(int v) { mgos_config_set_InnerOuterZone_index13(&mgos_sys_config, v); }

/* InnerOuterZone.index14 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX14
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX14
int mgos_config_get_InnerOuterZone_index14(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index14(void);
static inline int mgos_sys_config_get_InnerOuterZone_index14(void) { return mgos_config_get_InnerOuterZone_index14(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index14(void) { return mgos_config_get_default_InnerOuterZone_index14(); }
void mgos_config_set_InnerOuterZone_index14(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index14(int v) { mgos_config_set_InnerOuterZone_index14(&mgos_sys_config, v); }

/* InnerOuterZone.index15 */
#define MGOS_CONFIG_HAVE_INNEROUTERZONE_INDEX15
#define MGOS_SYS_CONFIG_HAVE_INNEROUTERZONE_INDEX15
int mgos_config_get_InnerOuterZone_index15(const struct mgos_config *cfg);
int mgos_config_get_default_InnerOuterZone_index15(void);
static inline int mgos_sys_config_get_InnerOuterZone_index15(void) { return mgos_config_get_InnerOuterZone_index15(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_InnerOuterZone_index15(void) { return mgos_config_get_default_InnerOuterZone_index15(); }
void mgos_config_set_InnerOuterZone_index15(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_InnerOuterZone_index15(int v) { mgos_config_set_InnerOuterZone_index15(&mgos_sys_config, v); }

/* distanceThreshold */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD
const struct mgos_config_distanceThreshold *mgos_config_get_distanceThreshold(const struct mgos_config *cfg);
static inline const struct mgos_config_distanceThreshold *mgos_sys_config_get_distanceThreshold(void) { return mgos_config_get_distanceThreshold(&mgos_sys_config); }

/* distanceThreshold.index0 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX0
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX0
int mgos_config_get_distanceThreshold_index0(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index0(void);
static inline int mgos_sys_config_get_distanceThreshold_index0(void) { return mgos_config_get_distanceThreshold_index0(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index0(void) { return mgos_config_get_default_distanceThreshold_index0(); }
void mgos_config_set_distanceThreshold_index0(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index0(int v) { mgos_config_set_distanceThreshold_index0(&mgos_sys_config, v); }

/* distanceThreshold.index1 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX1
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX1
int mgos_config_get_distanceThreshold_index1(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index1(void);
static inline int mgos_sys_config_get_distanceThreshold_index1(void) { return mgos_config_get_distanceThreshold_index1(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index1(void) { return mgos_config_get_default_distanceThreshold_index1(); }
void mgos_config_set_distanceThreshold_index1(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index1(int v) { mgos_config_set_distanceThreshold_index1(&mgos_sys_config, v); }

/* distanceThreshold.index2 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX2
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX2
int mgos_config_get_distanceThreshold_index2(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index2(void);
static inline int mgos_sys_config_get_distanceThreshold_index2(void) { return mgos_config_get_distanceThreshold_index2(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index2(void) { return mgos_config_get_default_distanceThreshold_index2(); }
void mgos_config_set_distanceThreshold_index2(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index2(int v) { mgos_config_set_distanceThreshold_index2(&mgos_sys_config, v); }

/* distanceThreshold.index3 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX3
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX3
int mgos_config_get_distanceThreshold_index3(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index3(void);
static inline int mgos_sys_config_get_distanceThreshold_index3(void) { return mgos_config_get_distanceThreshold_index3(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index3(void) { return mgos_config_get_default_distanceThreshold_index3(); }
void mgos_config_set_distanceThreshold_index3(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index3(int v) { mgos_config_set_distanceThreshold_index3(&mgos_sys_config, v); }

/* distanceThreshold.index4 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX4
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX4
int mgos_config_get_distanceThreshold_index4(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index4(void);
static inline int mgos_sys_config_get_distanceThreshold_index4(void) { return mgos_config_get_distanceThreshold_index4(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index4(void) { return mgos_config_get_default_distanceThreshold_index4(); }
void mgos_config_set_distanceThreshold_index4(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index4(int v) { mgos_config_set_distanceThreshold_index4(&mgos_sys_config, v); }

/* distanceThreshold.index5 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX5
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX5
int mgos_config_get_distanceThreshold_index5(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index5(void);
static inline int mgos_sys_config_get_distanceThreshold_index5(void) { return mgos_config_get_distanceThreshold_index5(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index5(void) { return mgos_config_get_default_distanceThreshold_index5(); }
void mgos_config_set_distanceThreshold_index5(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index5(int v) { mgos_config_set_distanceThreshold_index5(&mgos_sys_config, v); }

/* distanceThreshold.index6 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX6
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX6
int mgos_config_get_distanceThreshold_index6(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index6(void);
static inline int mgos_sys_config_get_distanceThreshold_index6(void) { return mgos_config_get_distanceThreshold_index6(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index6(void) { return mgos_config_get_default_distanceThreshold_index6(); }
void mgos_config_set_distanceThreshold_index6(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index6(int v) { mgos_config_set_distanceThreshold_index6(&mgos_sys_config, v); }

/* distanceThreshold.index7 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX7
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX7
int mgos_config_get_distanceThreshold_index7(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index7(void);
static inline int mgos_sys_config_get_distanceThreshold_index7(void) { return mgos_config_get_distanceThreshold_index7(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index7(void) { return mgos_config_get_default_distanceThreshold_index7(); }
void mgos_config_set_distanceThreshold_index7(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index7(int v) { mgos_config_set_distanceThreshold_index7(&mgos_sys_config, v); }

/* distanceThreshold.index8 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX8
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX8
int mgos_config_get_distanceThreshold_index8(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index8(void);
static inline int mgos_sys_config_get_distanceThreshold_index8(void) { return mgos_config_get_distanceThreshold_index8(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index8(void) { return mgos_config_get_default_distanceThreshold_index8(); }
void mgos_config_set_distanceThreshold_index8(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index8(int v) { mgos_config_set_distanceThreshold_index8(&mgos_sys_config, v); }

/* distanceThreshold.index9 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX9
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX9
int mgos_config_get_distanceThreshold_index9(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index9(void);
static inline int mgos_sys_config_get_distanceThreshold_index9(void) { return mgos_config_get_distanceThreshold_index9(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index9(void) { return mgos_config_get_default_distanceThreshold_index9(); }
void mgos_config_set_distanceThreshold_index9(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index9(int v) { mgos_config_set_distanceThreshold_index9(&mgos_sys_config, v); }

/* distanceThreshold.index10 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX10
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX10
int mgos_config_get_distanceThreshold_index10(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index10(void);
static inline int mgos_sys_config_get_distanceThreshold_index10(void) { return mgos_config_get_distanceThreshold_index10(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index10(void) { return mgos_config_get_default_distanceThreshold_index10(); }
void mgos_config_set_distanceThreshold_index10(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index10(int v) { mgos_config_set_distanceThreshold_index10(&mgos_sys_config, v); }

/* distanceThreshold.index11 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX11
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX11
int mgos_config_get_distanceThreshold_index11(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index11(void);
static inline int mgos_sys_config_get_distanceThreshold_index11(void) { return mgos_config_get_distanceThreshold_index11(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index11(void) { return mgos_config_get_default_distanceThreshold_index11(); }
void mgos_config_set_distanceThreshold_index11(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index11(int v) { mgos_config_set_distanceThreshold_index11(&mgos_sys_config, v); }

/* distanceThreshold.index12 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX12
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX12
int mgos_config_get_distanceThreshold_index12(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index12(void);
static inline int mgos_sys_config_get_distanceThreshold_index12(void) { return mgos_config_get_distanceThreshold_index12(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index12(void) { return mgos_config_get_default_distanceThreshold_index12(); }
void mgos_config_set_distanceThreshold_index12(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index12(int v) { mgos_config_set_distanceThreshold_index12(&mgos_sys_config, v); }

/* distanceThreshold.index13 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX13
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX13
int mgos_config_get_distanceThreshold_index13(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index13(void);
static inline int mgos_sys_config_get_distanceThreshold_index13(void) { return mgos_config_get_distanceThreshold_index13(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index13(void) { return mgos_config_get_default_distanceThreshold_index13(); }
void mgos_config_set_distanceThreshold_index13(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index13(int v) { mgos_config_set_distanceThreshold_index13(&mgos_sys_config, v); }

/* distanceThreshold.index14 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX14
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX14
int mgos_config_get_distanceThreshold_index14(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index14(void);
static inline int mgos_sys_config_get_distanceThreshold_index14(void) { return mgos_config_get_distanceThreshold_index14(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index14(void) { return mgos_config_get_default_distanceThreshold_index14(); }
void mgos_config_set_distanceThreshold_index14(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index14(int v) { mgos_config_set_distanceThreshold_index14(&mgos_sys_config, v); }

/* distanceThreshold.index15 */
#define MGOS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX15
#define MGOS_SYS_CONFIG_HAVE_DISTANCETHRESHOLD_INDEX15
int mgos_config_get_distanceThreshold_index15(const struct mgos_config *cfg);
int mgos_config_get_default_distanceThreshold_index15(void);
static inline int mgos_sys_config_get_distanceThreshold_index15(void) { return mgos_config_get_distanceThreshold_index15(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_distanceThreshold_index15(void) { return mgos_config_get_default_distanceThreshold_index15(); }
void mgos_config_set_distanceThreshold_index15(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_distanceThreshold_index15(int v) { mgos_config_set_distanceThreshold_index15(&mgos_sys_config, v); }

/* mindistance */
#define MGOS_CONFIG_HAVE_MINDISTANCE
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE
const struct mgos_config_mindistance *mgos_config_get_mindistance(const struct mgos_config *cfg);
static inline const struct mgos_config_mindistance *mgos_sys_config_get_mindistance(void) { return mgos_config_get_mindistance(&mgos_sys_config); }

/* mindistance.index0 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX0
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX0
int mgos_config_get_mindistance_index0(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index0(void);
static inline int mgos_sys_config_get_mindistance_index0(void) { return mgos_config_get_mindistance_index0(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index0(void) { return mgos_config_get_default_mindistance_index0(); }
void mgos_config_set_mindistance_index0(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index0(int v) { mgos_config_set_mindistance_index0(&mgos_sys_config, v); }

/* mindistance.index1 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX1
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX1
int mgos_config_get_mindistance_index1(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index1(void);
static inline int mgos_sys_config_get_mindistance_index1(void) { return mgos_config_get_mindistance_index1(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index1(void) { return mgos_config_get_default_mindistance_index1(); }
void mgos_config_set_mindistance_index1(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index1(int v) { mgos_config_set_mindistance_index1(&mgos_sys_config, v); }

/* mindistance.index2 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX2
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX2
int mgos_config_get_mindistance_index2(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index2(void);
static inline int mgos_sys_config_get_mindistance_index2(void) { return mgos_config_get_mindistance_index2(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index2(void) { return mgos_config_get_default_mindistance_index2(); }
void mgos_config_set_mindistance_index2(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index2(int v) { mgos_config_set_mindistance_index2(&mgos_sys_config, v); }

/* mindistance.index3 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX3
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX3
int mgos_config_get_mindistance_index3(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index3(void);
static inline int mgos_sys_config_get_mindistance_index3(void) { return mgos_config_get_mindistance_index3(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index3(void) { return mgos_config_get_default_mindistance_index3(); }
void mgos_config_set_mindistance_index3(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index3(int v) { mgos_config_set_mindistance_index3(&mgos_sys_config, v); }

/* mindistance.index4 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX4
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX4
int mgos_config_get_mindistance_index4(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index4(void);
static inline int mgos_sys_config_get_mindistance_index4(void) { return mgos_config_get_mindistance_index4(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index4(void) { return mgos_config_get_default_mindistance_index4(); }
void mgos_config_set_mindistance_index4(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index4(int v) { mgos_config_set_mindistance_index4(&mgos_sys_config, v); }

/* mindistance.index5 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX5
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX5
int mgos_config_get_mindistance_index5(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index5(void);
static inline int mgos_sys_config_get_mindistance_index5(void) { return mgos_config_get_mindistance_index5(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index5(void) { return mgos_config_get_default_mindistance_index5(); }
void mgos_config_set_mindistance_index5(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index5(int v) { mgos_config_set_mindistance_index5(&mgos_sys_config, v); }

/* mindistance.index6 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX6
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX6
int mgos_config_get_mindistance_index6(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index6(void);
static inline int mgos_sys_config_get_mindistance_index6(void) { return mgos_config_get_mindistance_index6(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index6(void) { return mgos_config_get_default_mindistance_index6(); }
void mgos_config_set_mindistance_index6(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index6(int v) { mgos_config_set_mindistance_index6(&mgos_sys_config, v); }

/* mindistance.index7 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX7
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX7
int mgos_config_get_mindistance_index7(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index7(void);
static inline int mgos_sys_config_get_mindistance_index7(void) { return mgos_config_get_mindistance_index7(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index7(void) { return mgos_config_get_default_mindistance_index7(); }
void mgos_config_set_mindistance_index7(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index7(int v) { mgos_config_set_mindistance_index7(&mgos_sys_config, v); }

/* mindistance.index8 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX8
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX8
int mgos_config_get_mindistance_index8(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index8(void);
static inline int mgos_sys_config_get_mindistance_index8(void) { return mgos_config_get_mindistance_index8(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index8(void) { return mgos_config_get_default_mindistance_index8(); }
void mgos_config_set_mindistance_index8(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index8(int v) { mgos_config_set_mindistance_index8(&mgos_sys_config, v); }

/* mindistance.index9 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX9
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX9
int mgos_config_get_mindistance_index9(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index9(void);
static inline int mgos_sys_config_get_mindistance_index9(void) { return mgos_config_get_mindistance_index9(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index9(void) { return mgos_config_get_default_mindistance_index9(); }
void mgos_config_set_mindistance_index9(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index9(int v) { mgos_config_set_mindistance_index9(&mgos_sys_config, v); }

/* mindistance.index10 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX10
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX10
int mgos_config_get_mindistance_index10(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index10(void);
static inline int mgos_sys_config_get_mindistance_index10(void) { return mgos_config_get_mindistance_index10(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index10(void) { return mgos_config_get_default_mindistance_index10(); }
void mgos_config_set_mindistance_index10(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index10(int v) { mgos_config_set_mindistance_index10(&mgos_sys_config, v); }

/* mindistance.index11 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX11
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX11
int mgos_config_get_mindistance_index11(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index11(void);
static inline int mgos_sys_config_get_mindistance_index11(void) { return mgos_config_get_mindistance_index11(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index11(void) { return mgos_config_get_default_mindistance_index11(); }
void mgos_config_set_mindistance_index11(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index11(int v) { mgos_config_set_mindistance_index11(&mgos_sys_config, v); }

/* mindistance.index12 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX12
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX12
int mgos_config_get_mindistance_index12(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index12(void);
static inline int mgos_sys_config_get_mindistance_index12(void) { return mgos_config_get_mindistance_index12(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index12(void) { return mgos_config_get_default_mindistance_index12(); }
void mgos_config_set_mindistance_index12(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index12(int v) { mgos_config_set_mindistance_index12(&mgos_sys_config, v); }

/* mindistance.index13 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX13
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX13
int mgos_config_get_mindistance_index13(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index13(void);
static inline int mgos_sys_config_get_mindistance_index13(void) { return mgos_config_get_mindistance_index13(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index13(void) { return mgos_config_get_default_mindistance_index13(); }
void mgos_config_set_mindistance_index13(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index13(int v) { mgos_config_set_mindistance_index13(&mgos_sys_config, v); }

/* mindistance.index14 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX14
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX14
int mgos_config_get_mindistance_index14(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index14(void);
static inline int mgos_sys_config_get_mindistance_index14(void) { return mgos_config_get_mindistance_index14(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index14(void) { return mgos_config_get_default_mindistance_index14(); }
void mgos_config_set_mindistance_index14(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index14(int v) { mgos_config_set_mindistance_index14(&mgos_sys_config, v); }

/* mindistance.index15 */
#define MGOS_CONFIG_HAVE_MINDISTANCE_INDEX15
#define MGOS_SYS_CONFIG_HAVE_MINDISTANCE_INDEX15
int mgos_config_get_mindistance_index15(const struct mgos_config *cfg);
int mgos_config_get_default_mindistance_index15(void);
static inline int mgos_sys_config_get_mindistance_index15(void) { return mgos_config_get_mindistance_index15(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_mindistance_index15(void) { return mgos_config_get_default_mindistance_index15(); }
void mgos_config_set_mindistance_index15(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_mindistance_index15(int v) { mgos_config_set_mindistance_index15(&mgos_sys_config, v); }
