...
#else
    {.name = "location", .version = "1.0", .repo_version = "6df89db17dd04ee5c58d664ca687de9a5b575e20", .binary_libs = NULL, .init = mgos_location_init},
#endif
...
#else
    {.name = "cron", .version = "1.0", .repo_version = "b7faa91f253bd7522a10bfb4b9ba39397e2bcf51", .binary_libs = NULL, .init = mgos_cron_init},
#endif
