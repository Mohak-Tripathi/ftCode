...
// Consecutive number of samples in which people detected
	...
	// dwpcData.distanceThreshold = PathZonesCount;
...
void getpixelcount(VL53L5CX_ResultsData *pRangeResults, uint8_t *pPathZones)
{
	uint16_t newFrame[NB_ZONES];
