...
static const struct mgos_conf_entry mgos_config_schema_[] = {
    {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 305},
    ...
    {.type = CONF_TYPE_OBJECT, .key = "iaq", .offset = offsetof(struct mgos_config, iaq), .num_desc = 19},
    {.type = CONF_TYPE_INT, .key = "measurementinterval", .offset = offsetof(struct mgos_config, iaq.measurementinterval)},
    {.type = CONF_TYPE_INT, .key = "publishinterval", .offset = offsetof(struct mgos_config, iaq.publishinterval)},
    {.type = CONF_TYPE_INT, .key = "periodicinterval", .offset = offsetof(struct mgos_config, iaq.periodicinterval)},
    {.type = CONF_TYPE_BOOL, .key = "pir", .offset = offsetof(struct mgos_config, iaq.pir)},
    {.type = CONF_TYPE_INT, .key = "temperature", .offset = offsetof(struct mgos_config, iaq.temperature)},
    {.type = CONF_TYPE_INT, .key = "humidiy", .offset = offsetof(struct mgos_config, iaq.humidiy)},
    {.type = CONF_TYPE_INT, .key = "lux", .offset = offsetof(struct mgos_config, iaq.lux)},
    {.type = CONF_TYPE_INT, .key = "co2", .offset = offsetof(struct mgos_config, iaq.co2)},
    {.type = CONF_TYPE_INT, .key = "pm_1", .offset = offsetof(struct mgos_config, iaq.pm_1)},
    {.type = CONF_TYPE_INT, .key = "pm_2_5", .offset = offsetof(struct mgos_config, iaq.pm_2_5)},
    {.type = CONF_TYPE_INT, .key = "pm_4", .offset = offsetof(struct mgos_config, iaq.pm_4)},
    {.type = CONF_TYPE_INT, .key = "pm_10", .offset = offsetof(struct mgos_config, iaq.pm_10)},
    {.type = CONF_TYPE_INT, .key = "Tvoc_offset", .offset = offsetof(struct mgos_config, iaq.Tvoc_offset)},
    {.type = CONF_TYPE_INT, .key = "noise_offset", .offset = offsetof(struct mgos_config, iaq.noise_offset)},
    {.type = CONF_TYPE_INT, .key = "co2FCReference", .offset = offsetof(struct mgos_config, iaq.co2FCReference)},
    {.type = CONF_TYPE_INT, .key = "FanFCReference", .offset = offsetof(struct mgos_config, iaq.FanFCReference)},
    {.type = CONF_TYPE_INT, .key = "formaldehyde_offset", .offset = offsetof(struct mgos_config, iaq.formaldehyde_offset)},
    {.type = CONF_TYPE_INT, .key = "air_pressure_offset", .offset = offsetof(struct mgos_config, iaq.air_pressure_offset)},
    {.type = CONF_TYPE_INT, .key = "output_type", .offset = offsetof(struct mgos_config, iaq.output_type)},
};
...
void mgos_config_debug_set_defaults(struct mgos_config_debug *cfg) {
  cfg->udp_log_addr = "192.168.10.61:1993";
  cfg->udp_log_level = 3;
  cfg->mbedtls_level = 1;
  cfg->level = 2;
  cfg->file_level = NULL;
...
bool mgos_config_file_logger_parse_f(const char *fname, struct mgos_config_file_logger *cfg) {
  ...
  char *data = cs_read_file(fname, &len);
  if (data == NULL) return false;
  bool res = mgos_config_file_logger_parse(mg_mk_str_n(data, len), cfg);
  free(data);
  return res;
}
...
const struct mgos_conf_entry *mgos_config_wifi_ap_get_schema(void) {
  return &mgos_config_schema_[182];
}
...
const struct mgos_conf_entry *mgos_config_board_btn3_get_schema(void) {
  return &mgos_config_schema_[280];
}
...
const struct mgos_conf_entry *mgos_config_iaq_get_schema(void) {
  return &mgos_config_schema_[286];
}

void mgos_config_iaq_set_defaults(struct mgos_config_iaq *cfg) {
  cfg->measurementinterval = 10;
  cfg->publishinterval = 30;
  cfg->periodicinterval = 45;
  cfg->pir = false;
  cfg->temperature = 0;
  cfg->humidiy = 0;
  cfg->lux = 0;
  ...
  cfg->Tvoc_offset = 0;
  cfg->noise_offset = 0;
  cfg->co2FCReference = 400;
  cfg->FanFCReference = 0;
  cfg->formaldehyde_offset = 0;
  cfg->air_pressure_offset = 0;
  cfg->output_type = 0;
}
bool mgos_config_iaq_parse_f(const char *fname, struct mgos_config_iaq *cfg) {
  ...
  char *data = cs_read_file(fname, &len);
  if (data == NULL) return false;
  bool res = mgos_config_iaq_parse(mg_mk_str_n(data, len), cfg);
  free(data);
  return res;
}
...
void mgos_config_set_defaults(struct mgos_config *cfg) {
  ...
  mgos_config_iaq_set_defaults(&cfg->iaq);
}
...
const char * mgos_config_get_default_debug_udp_log_addr(void) { return "192.168.10.61:1993"; }
...
int mgos_config_get_default_eth_phy_pwr_gpio(void) { return 15; }
...
const char * mgos_config_get_default_mqtt_pub(void) { return "/test/iaq"; }
...
const char * mgos_config_get_default_mqtt1_pub(void) { return "/test/iaq"; }
...
const char * mgos_config_get_default_wifi_ap_ssid(void) { return "IAQ_V2.5"; }
...
const char * mgos_config_get_default_admin_variant(void) { return "MQTT"; }
...
const char * mgos_config_get_default_admin_version(void) { return "v2.5_7-12-23"; }
void mgos_config_set_admin_version(struct mgos_config *cfg, const char * v) { mgos_conf_set_str(&cfg->admin.version, v); }

/* iaq */
const struct mgos_config_iaq *mgos_config_get_iaq(const struct mgos_config *cfg) { return &cfg->iaq; }

/* iaq.measurementinterval */
int mgos_config_get_iaq_measurementinterval(const struct mgos_config *cfg) { return cfg->iaq.measurementinterval; }
int mgos_config_get_default_iaq_measurementinterval(void) { return 10; }
void mgos_config_set_iaq_measurementinterval(struct mgos_config *cfg, int v) { cfg->iaq.measurementinterval = v; }

/* iaq.publishinterval */
int mgos_config_get_iaq_publishinterval(const struct mgos_config *cfg) { return cfg->iaq.publishinterval; }
int mgos_config_get_default_iaq_publishinterval(void) { return 30; }
void mgos_config_set_iaq_publishinterval(struct mgos_config *cfg, int v) { cfg->iaq.publishinterval = v; }

/* iaq.periodicinterval */
int mgos_config_get_iaq_periodicinterval(const struct mgos_config *cfg) { return cfg->iaq.periodicinterval; }
int mgos_config_get_default_iaq_periodicinterval(void) { return 45; }
void mgos_config_set_iaq_periodicinterval(struct mgos_config *cfg, int v) { cfg->iaq.periodicinterval = v; }

/* iaq.pir */
int mgos_config_get_iaq_pir(const struct mgos_config *cfg) { return cfg->iaq.pir; }
int mgos_config_get_default_iaq_pir(void) { return false; }
void mgos_config_set_iaq_pir(struct mgos_config *cfg, int v) { cfg->iaq.pir = v; }

/* iaq.temperature */
int mgos_config_get_iaq_temperature(const struct mgos_config *cfg) { return cfg->iaq.temperature; }
int mgos_config_get_default_iaq_temperature(void) { return 0; }
void mgos_config_set_iaq_temperature(struct mgos_config *cfg, int v) { cfg->iaq.temperature = v; }

/* iaq.humidiy */
int mgos_config_get_iaq_humidiy(const struct mgos_config *cfg) { return cfg->iaq.humidiy; }
int mgos_config_get_default_iaq_humidiy(void) { return 0; }
void mgos_config_set_iaq_humidiy(struct mgos_config *cfg, int v) { cfg->iaq.humidiy = v; }

/* iaq.lux */
int mgos_config_get_iaq_lux(const struct mgos_config *cfg) { return cfg->iaq.lux; }
int mgos_config_get_default_iaq_lux(void) { return 0; }
void mgos_config_set_iaq_lux(struct mgos_config *cfg, int v) { cfg->iaq.lux = v; }

/* iaq.co2 */
int mgos_config_get_iaq_co2(const struct mgos_config *cfg) { return cfg->iaq.co2; }
int mgos_config_get_default_iaq_co2(void) { return 0; }
void mgos_config_set_iaq_co2(struct mgos_config *cfg, int v) { cfg->iaq.co2 = v; }

/* iaq.pm_1 */
int mgos_config_get_iaq_pm_1(const struct mgos_config *cfg) { return cfg->iaq.pm_1; }
int mgos_config_get_default_iaq_pm_1(void) { return 0; }
void mgos_config_set_iaq_pm_1(struct mgos_config *cfg, int v) { cfg->iaq.pm_1 = v; }

/* iaq.pm_2_5 */
int mgos_config_get_iaq_pm_2_5(const struct mgos_config *cfg) { return cfg->iaq.pm_2_5; }
int mgos_config_get_default_iaq_pm_2_5(void) { return 0; }
void mgos_config_set_iaq_pm_2_5(struct mgos_config *cfg, int v) { cfg->iaq.pm_2_5 = v; }

/* iaq.pm_4 */
int mgos_config_get_iaq_pm_4(const struct mgos_config *cfg) { return cfg->iaq.pm_4; }
int mgos_config_get_default_iaq_pm_4(void) { return 0; }
void mgos_config_set_iaq_pm_4(struct mgos_config *cfg, int v) { cfg->iaq.pm_4 = v; }

/* iaq.pm_10 */
int mgos_config_get_iaq_pm_10(const struct mgos_config *cfg) { return cfg->iaq.pm_10; }
int mgos_config_get_default_iaq_pm_10(void) { return 0; }
void mgos_config_set_iaq_pm_10(struct mgos_config *cfg, int v) { cfg->iaq.pm_10 = v; }

/* iaq.Tvoc_offset */
int mgos_config_get_iaq_Tvoc_offset(const struct mgos_config *cfg) { return cfg->iaq.Tvoc_offset; }
int mgos_config_get_default_iaq_Tvoc_offset(void) { return 0; }
void mgos_config_set_iaq_Tvoc_offset(struct mgos_config *cfg, int v) { cfg->iaq.Tvoc_offset = v; }

/* iaq.noise_offset */
int mgos_config_get_iaq_noise_offset(const struct mgos_config *cfg) { return cfg->iaq.noise_offset; }
int mgos_config_get_default_iaq_noise_offset(void) { return 0; }
void mgos_config_set_iaq_noise_offset(struct mgos_config *cfg, int v) { cfg->iaq.noise_offset = v; }

/* iaq.co2FCReference */
int mgos_config_get_iaq_co2FCReference(const struct mgos_config *cfg) { return cfg->iaq.co2FCReference; }
int mgos_config_get_default_iaq_co2FCReference(void) { return 400; }
void mgos_config_set_iaq_co2FCReference(struct mgos_config *cfg, int v) { cfg->iaq.co2FCReference = v; }

/* iaq.FanFCReference */
int mgos_config_get_iaq_FanFCReference(const struct mgos_config *cfg) { return cfg->iaq.FanFCReference; }
int mgos_config_get_default_iaq_FanFCReference(void) { return 0; }
void mgos_config_set_iaq_FanFCReference(struct mgos_config *cfg, int v) { cfg->iaq.FanFCReference = v; }

/* iaq.formaldehyde_offset */
int mgos_config_get_iaq_formaldehyde_offset(const struct mgos_config *cfg) { return cfg->iaq.formaldehyde_offset; }
int mgos_config_get_default_iaq_formaldehyde_offset(void) { return 0; }
void mgos_config_set_iaq_formaldehyde_offset(struct mgos_config *cfg, int v) { cfg->iaq.formaldehyde_offset = v; }

/* iaq.air_pressure_offset */
int mgos_config_get_iaq_air_pressure_offset(const struct mgos_config *cfg) { return cfg->iaq.air_pressure_offset; }
int mgos_config_get_default_iaq_air_pressure_offset(void) { return 0; }
void mgos_config_set_iaq_air_pressure_offset(struct mgos_config *cfg, int v) { cfg->iaq.air_pressure_offset = v; }

/* iaq.output_type */
int mgos_config_get_iaq_output_type(const struct mgos_config *cfg) { return cfg->iaq.output_type; }
int mgos_config_get_default_iaq_output_type(void) { return 0; }
void mgos_config_set_iaq_output_type(struct mgos_config *cfg, int v) { cfg->iaq.output_type = v; }
