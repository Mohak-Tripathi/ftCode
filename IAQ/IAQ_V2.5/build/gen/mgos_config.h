 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.20.0/apps/IAQ_V2.5/esp32/build_contexts/build_ctx_968490450/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/2.20.0/apps/IAQ_V2.5/esp32/build_contexts/build_ctx_968490450/build/gen/mos_conf_schema.yml
 */
...
/* file_logger type struct mgos_config_file_logger */
...
static inline bool mgos_config_file_logger_parse(struct mg_str json, struct mgos_config_file_logger *cfg) {
  mgos_config_file_logger_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_file_logger_get_schema(), cfg);
}
bool mgos_config_file_logger_parse_f(const char *fname, struct mgos_config_file_logger *cfg);
static inline bool mgos_config_file_logger_emit(const struct mgos_config_file_logger *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_file_logger_get_schema(), pretty, out);
}
static inline bool mgos_config_file_logger_emit_f(const struct mgos_config_file_logger *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_file_logger_get_schema(), pretty, fname);
}
static inline bool mgos_config_file_logger_copy(const struct mgos_config_file_logger *src, struct mgos_config_file_logger *dst) {
  return mgos_conf_copy(mgos_config_file_logger_get_schema(), src, dst);
}
static inline void mgos_config_file_logger_free(struct mgos_config_file_logger *cfg) {
  return mgos_conf_free(mgos_config_file_logger_get_schema(), cfg);
}
...
/* iaq type struct mgos_config_iaq */
struct mgos_config_iaq {
  ...
  int co2FCReference;
  int FanFCReference;
  int formaldehyde_offset;
  int air_pressure_offset;
  int output_type;
};
const struct mgos_conf_entry *mgos_config_iaq_get_schema(void);
void mgos_config_iaq_set_defaults(struct mgos_config_iaq *cfg);
static inline bool mgos_config_iaq_parse(struct mg_str json, struct mgos_config_iaq *cfg) {
  mgos_config_iaq_set_defaults(cfg);
  return mgos_conf_parse_sub(json, mgos_config_iaq_get_schema(), cfg);
}
bool mgos_config_iaq_parse_f(const char *fname, struct mgos_config_iaq *cfg);
static inline bool mgos_config_iaq_emit(const struct mgos_config_iaq *cfg, bool pretty, struct json_out *out) {
  return mgos_conf_emit_json_out(cfg, NULL, mgos_config_iaq_get_schema(), pretty, out);
}
static inline bool mgos_config_iaq_emit_f(const struct mgos_config_iaq *cfg, bool pretty, const char *fname) {
  return mgos_conf_emit_f(cfg, NULL, mgos_config_iaq_get_schema(), pretty, fname);
}
static inline bool mgos_config_iaq_copy(const struct mgos_config_iaq *src, struct mgos_config_iaq *dst) {
  return mgos_conf_copy(mgos_config_iaq_get_schema(), src, dst);
}
static inline void mgos_config_iaq_free(struct mgos_config_iaq *cfg) {
  return mgos_conf_free(mgos_config_iaq_get_schema(), cfg);
}
...
const struct mgos_config_file_logger *mgos_config_get_file_logger(const struct mgos_config *cfg);
...
int mgos_config_get_file_logger_enable(const struct mgos_config *cfg);
int mgos_config_get_default_file_logger_enable(void);
static inline int mgos_sys_config_get_file_logger_enable(void) { return mgos_config_get_file_logger_enable(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_file_logger_enable(void) { return mgos_config_get_default_file_logger_enable(); }
...
const char * mgos_config_get_file_logger_dir(const struct mgos_config *cfg);
const char * mgos_config_get_default_file_logger_dir(void);
static inline const char * mgos_sys_config_get_file_logger_dir(void) { return mgos_config_get_file_logger_dir(&mgos_sys_config); }
static inline const char * mgos_sys_config_get_default_file_logger_dir(void) { return mgos_config_get_default_file_logger_dir(); }
...
const char * mgos_config_get_file_logger_prefix(const struct mgos_config *cfg);
const char * mgos_config_get_default_file_logger_prefix(void);
...
static inline const char * mgos_sys_config_get_default_file_logger_prefix(void) { return mgos_config_get_default_file_logger_prefix(); }
...
int mgos_config_get_file_logger_max_file_size(const struct mgos_config *cfg);
int mgos_config_get_default_file_logger_max_file_size(void);
...
static inline int mgos_sys_config_get_default_file_logger_max_file_size(void) { return mgos_config_get_default_file_logger_max_file_size(); }
...
int mgos_config_get_file_logger_max_num_files(const struct mgos_config *cfg);
int mgos_config_get_default_file_logger_max_num_files(void);
...
static inline int mgos_sys_config_get_default_file_logger_max_num_files(void) { return mgos_config_get_default_file_logger_max_num_files(); }
...
int mgos_config_get_file_logger_timestamps(const struct mgos_config *cfg);
int mgos_config_get_default_file_logger_timestamps(void);
...
static inline int mgos_sys_config_get_default_file_logger_timestamps(void) { return mgos_config_get_default_file_logger_timestamps(); }
...
int mgos_config_get_file_logger_level(const struct mgos_config *cfg);
int mgos_config_get_default_file_logger_level(void);
static inline int mgos_sys_config_get_file_logger_level(void) { return mgos_config_get_file_logger_level(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_file_logger_level(void) { return mgos_config_get_default_file_logger_level(); }
...
const char * mgos_config_get_file_logger_include(const struct mgos_config *cfg);
const char * mgos_config_get_default_file_logger_include(void);
...
static inline const char * mgos_sys_config_get_default_file_logger_include(void) { return mgos_config_get_default_file_logger_include(); }
...
int mgos_config_get_file_logger_syslog_enable(const struct mgos_config *cfg);
int mgos_config_get_default_file_logger_syslog_enable(void);
...
static inline int mgos_sys_config_get_default_file_logger_syslog_enable(void) { return mgos_config_get_default_file_logger_syslog_enable(); }
...
int mgos_config_get_file_logger_rpc_service_enable(const struct mgos_config *cfg);
int mgos_config_get_default_file_logger_rpc_service_enable(void);
...
static inline int mgos_sys_config_get_default_file_logger_rpc_service_enable(void) { return mgos_config_get_default_file_logger_rpc_service_enable(); }
...
int mgos_config_get_file_logger_buf_size(const struct mgos_config *cfg);
int mgos_config_get_default_file_logger_buf_size(void);
...
static inline int mgos_sys_config_get_default_file_logger_buf_size(void) { return mgos_config_get_default_file_logger_buf_size(); }
...
int mgos_config_get_file_logger_buf_line(const struct mgos_config *cfg);
int mgos_config_get_default_file_logger_buf_line(void);
...
static inline int mgos_sys_config_get_default_file_logger_buf_line(void) { return mgos_config_get_default_file_logger_buf_line(); }
...
/* iaq */
#define MGOS_CONFIG_HAVE_IAQ
#define MGOS_SYS_CONFIG_HAVE_IAQ
const struct mgos_config_iaq *mgos_config_get_iaq(const struct mgos_config *cfg);
static inline const struct mgos_config_iaq *mgos_sys_config_get_iaq(void) { return mgos_config_get_iaq(&mgos_sys_config); }

/* iaq.measurementinterval */
#define MGOS_CONFIG_HAVE_IAQ_MEASUREMENTINTERVAL
#define MGOS_SYS_CONFIG_HAVE_IAQ_MEASUREMENTINTERVAL
int mgos_config_get_iaq_measurementinterval(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_measurementinterval(void);
static inline int mgos_sys_config_get_iaq_measurementinterval(void) { return mgos_config_get_iaq_measurementinterval(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_measurementinterval(void) { return mgos_config_get_default_iaq_measurementinterval(); }
void mgos_config_set_iaq_measurementinterval(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_measurementinterval(int v) { mgos_config_set_iaq_measurementinterval(&mgos_sys_config, v); }

/* iaq.publishinterval */
#define MGOS_CONFIG_HAVE_IAQ_PUBLISHINTERVAL
#define MGOS_SYS_CONFIG_HAVE_IAQ_PUBLISHINTERVAL
int mgos_config_get_iaq_publishinterval(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_publishinterval(void);
static inline int mgos_sys_config_get_iaq_publishinterval(void) { return mgos_config_get_iaq_publishinterval(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_publishinterval(void) { return mgos_config_get_default_iaq_publishinterval(); }
void mgos_config_set_iaq_publishinterval(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_publishinterval(int v) { mgos_config_set_iaq_publishinterval(&mgos_sys_config, v); }

/* iaq.periodicinterval */
#define MGOS_CONFIG_HAVE_IAQ_PERIODICINTERVAL
#define MGOS_SYS_CONFIG_HAVE_IAQ_PERIODICINTERVAL
int mgos_config_get_iaq_periodicinterval(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_periodicinterval(void);
static inline int mgos_sys_config_get_iaq_periodicinterval(void) { return mgos_config_get_iaq_periodicinterval(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_periodicinterval(void) { return mgos_config_get_default_iaq_periodicinterval(); }
void mgos_config_set_iaq_periodicinterval(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_periodicinterval(int v) { mgos_config_set_iaq_periodicinterval(&mgos_sys_config, v); }

/* iaq.pir */
#define MGOS_CONFIG_HAVE_IAQ_PIR
#define MGOS_SYS_CONFIG_HAVE_IAQ_PIR
int mgos_config_get_iaq_pir(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_pir(void);
static inline int mgos_sys_config_get_iaq_pir(void) { return mgos_config_get_iaq_pir(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_pir(void) { return mgos_config_get_default_iaq_pir(); }
void mgos_config_set_iaq_pir(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_pir(int v) { mgos_config_set_iaq_pir(&mgos_sys_config, v); }

/* iaq.temperature */
#define MGOS_CONFIG_HAVE_IAQ_TEMPERATURE
#define MGOS_SYS_CONFIG_HAVE_IAQ_TEMPERATURE
int mgos_config_get_iaq_temperature(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_temperature(void);
static inline int mgos_sys_config_get_iaq_temperature(void) { return mgos_config_get_iaq_temperature(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_temperature(void) { return mgos_config_get_default_iaq_temperature(); }
void mgos_config_set_iaq_temperature(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_temperature(int v) { mgos_config_set_iaq_temperature(&mgos_sys_config, v); }

/* iaq.humidiy */
#define MGOS_CONFIG_HAVE_IAQ_HUMIDIY
#define MGOS_SYS_CONFIG_HAVE_IAQ_HUMIDIY
int mgos_config_get_iaq_humidiy(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_humidiy(void);
static inline int mgos_sys_config_get_iaq_humidiy(void) { return mgos_config_get_iaq_humidiy(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_humidiy(void) { return mgos_config_get_default_iaq_humidiy(); }
void mgos_config_set_iaq_humidiy(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_humidiy(int v) { mgos_config_set_iaq_humidiy(&mgos_sys_config, v); }

/* iaq.lux */
#define MGOS_CONFIG_HAVE_IAQ_LUX
#define MGOS_SYS_CONFIG_HAVE_IAQ_LUX
int mgos_config_get_iaq_lux(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_lux(void);
static inline int mgos_sys_config_get_iaq_lux(void) { return mgos_config_get_iaq_lux(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_lux(void) { return mgos_config_get_default_iaq_lux(); }
void mgos_config_set_iaq_lux(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_lux(int v) { mgos_config_set_iaq_lux(&mgos_sys_config, v); }

/* iaq.co2 */
#define MGOS_CONFIG_HAVE_IAQ_CO2
#define MGOS_SYS_CONFIG_HAVE_IAQ_CO2
int mgos_config_get_iaq_co2(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_co2(void);
static inline int mgos_sys_config_get_iaq_co2(void) { return mgos_config_get_iaq_co2(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_co2(void) { return mgos_config_get_default_iaq_co2(); }
void mgos_config_set_iaq_co2(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_co2(int v) { mgos_config_set_iaq_co2(&mgos_sys_config, v); }

/* iaq.pm_1 */
#define MGOS_CONFIG_HAVE_IAQ_PM_1
#define MGOS_SYS_CONFIG_HAVE_IAQ_PM_1
int mgos_config_get_iaq_pm_1(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_pm_1(void);
static inline int mgos_sys_config_get_iaq_pm_1(void) { return mgos_config_get_iaq_pm_1(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_pm_1(void) { return mgos_config_get_default_iaq_pm_1(); }
void mgos_config_set_iaq_pm_1(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_pm_1(int v) { mgos_config_set_iaq_pm_1(&mgos_sys_config, v); }

/* iaq.pm_2_5 */
#define MGOS_CONFIG_HAVE_IAQ_PM_2_5
#define MGOS_SYS_CONFIG_HAVE_IAQ_PM_2_5
int mgos_config_get_iaq_pm_2_5(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_pm_2_5(void);
static inline int mgos_sys_config_get_iaq_pm_2_5(void) { return mgos_config_get_iaq_pm_2_5(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_pm_2_5(void) { return mgos_config_get_default_iaq_pm_2_5(); }
void mgos_config_set_iaq_pm_2_5(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_pm_2_5(int v) { mgos_config_set_iaq_pm_2_5(&mgos_sys_config, v); }

/* iaq.pm_4 */
#define MGOS_CONFIG_HAVE_IAQ_PM_4
#define MGOS_SYS_CONFIG_HAVE_IAQ_PM_4
int mgos_config_get_iaq_pm_4(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_pm_4(void);
static inline int mgos_sys_config_get_iaq_pm_4(void) { return mgos_config_get_iaq_pm_4(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_pm_4(void) { return mgos_config_get_default_iaq_pm_4(); }
void mgos_config_set_iaq_pm_4(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_pm_4(int v) { mgos_config_set_iaq_pm_4(&mgos_sys_config, v); }

/* iaq.pm_10 */
#define MGOS_CONFIG_HAVE_IAQ_PM_10
#define MGOS_SYS_CONFIG_HAVE_IAQ_PM_10
int mgos_config_get_iaq_pm_10(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_pm_10(void);
static inline int mgos_sys_config_get_iaq_pm_10(void) { return mgos_config_get_iaq_pm_10(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_pm_10(void) { return mgos_config_get_default_iaq_pm_10(); }
void mgos_config_set_iaq_pm_10(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_pm_10(int v) { mgos_config_set_iaq_pm_10(&mgos_sys_config, v); }

/* iaq.Tvoc_offset */
#define MGOS_CONFIG_HAVE_IAQ_TVOC_OFFSET
#define MGOS_SYS_CONFIG_HAVE_IAQ_TVOC_OFFSET
int mgos_config_get_iaq_Tvoc_offset(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_Tvoc_offset(void);
static inline int mgos_sys_config_get_iaq_Tvoc_offset(void) { return mgos_config_get_iaq_Tvoc_offset(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_Tvoc_offset(void) { return mgos_config_get_default_iaq_Tvoc_offset(); }
void mgos_config_set_iaq_Tvoc_offset(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_Tvoc_offset(int v) { mgos_config_set_iaq_Tvoc_offset(&mgos_sys_config, v); }

/* iaq.noise_offset */
#define MGOS_CONFIG_HAVE_IAQ_NOISE_OFFSET
#define MGOS_SYS_CONFIG_HAVE_IAQ_NOISE_OFFSET
int mgos_config_get_iaq_noise_offset(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_noise_offset(void);
static inline int mgos_sys_config_get_iaq_noise_offset(void) { return mgos_config_get_iaq_noise_offset(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_noise_offset(void) { return mgos_config_get_default_iaq_noise_offset(); }
void mgos_config_set_iaq_noise_offset(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_noise_offset(int v) { mgos_config_set_iaq_noise_offset(&mgos_sys_config, v); }

/* iaq.co2FCReference */
#define MGOS_CONFIG_HAVE_IAQ_CO2FCREFERENCE
#define MGOS_SYS_CONFIG_HAVE_IAQ_CO2FCREFERENCE
int mgos_config_get_iaq_co2FCReference(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_co2FCReference(void);
static inline int mgos_sys_config_get_iaq_co2FCReference(void) { return mgos_config_get_iaq_co2FCReference(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_co2FCReference(void) { return mgos_config_get_default_iaq_co2FCReference(); }
void mgos_config_set_iaq_co2FCReference(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_co2FCReference(int v) { mgos_config_set_iaq_co2FCReference(&mgos_sys_config, v); }

/* iaq.FanFCReference */
#define MGOS_CONFIG_HAVE_IAQ_FANFCREFERENCE
#define MGOS_SYS_CONFIG_HAVE_IAQ_FANFCREFERENCE
int mgos_config_get_iaq_FanFCReference(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_FanFCReference(void);
static inline int mgos_sys_config_get_iaq_FanFCReference(void) { return mgos_config_get_iaq_FanFCReference(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_FanFCReference(void) { return mgos_config_get_default_iaq_FanFCReference(); }
void mgos_config_set_iaq_FanFCReference(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_FanFCReference(int v) { mgos_config_set_iaq_FanFCReference(&mgos_sys_config, v); }

/* iaq.formaldehyde_offset */
#define MGOS_CONFIG_HAVE_IAQ_FORMALDEHYDE_OFFSET
#define MGOS_SYS_CONFIG_HAVE_IAQ_FORMALDEHYDE_OFFSET
int mgos_config_get_iaq_formaldehyde_offset(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_formaldehyde_offset(void);
static inline int mgos_sys_config_get_iaq_formaldehyde_offset(void) { return mgos_config_get_iaq_formaldehyde_offset(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_formaldehyde_offset(void) { return mgos_config_get_default_iaq_formaldehyde_offset(); }
void mgos_config_set_iaq_formaldehyde_offset(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_formaldehyde_offset(int v) { mgos_config_set_iaq_formaldehyde_offset(&mgos_sys_config, v); }

/* iaq.air_pressure_offset */
#define MGOS_CONFIG_HAVE_IAQ_AIR_PRESSURE_OFFSET
#define MGOS_SYS_CONFIG_HAVE_IAQ_AIR_PRESSURE_OFFSET
int mgos_config_get_iaq_air_pressure_offset(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_air_pressure_offset(void);
static inline int mgos_sys_config_get_iaq_air_pressure_offset(void) { return mgos_config_get_iaq_air_pressure_offset(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_air_pressure_offset(void) { return mgos_config_get_default_iaq_air_pressure_offset(); }
void mgos_config_set_iaq_air_pressure_offset(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_air_pressure_offset(int v) { mgos_config_set_iaq_air_pressure_offset(&mgos_sys_config, v); }

/* iaq.output_type */
#define MGOS_CONFIG_HAVE_IAQ_OUTPUT_TYPE
#define MGOS_SYS_CONFIG_HAVE_IAQ_OUTPUT_TYPE
int mgos_config_get_iaq_output_type(const struct mgos_config *cfg);
int mgos_config_get_default_iaq_output_type(void);
static inline int mgos_sys_config_get_iaq_output_type(void) { return mgos_config_get_iaq_output_type(&mgos_sys_config); }
static inline int mgos_sys_config_get_default_iaq_output_type(void) { return mgos_config_get_default_iaq_output_type(); }
void mgos_config_set_iaq_output_type(struct mgos_config *cfg, int v);
static inline void mgos_sys_config_set_iaq_output_type(int v) { mgos_config_set_iaq_output_type(&mgos_sys_config, v); }
