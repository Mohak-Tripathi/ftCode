  ...
  return `<div class="container d-flex justify-content-evenly">
      ...
      <div class="navbar-brand ms-0" >
        ...
        <div class="d-flex">
          ...
          <a class="btn btn-primary px-3 me-2" id="admin-nav" href="./admin.html" role="button" >  Admin </a>
     
          <a class="btn btn-primary px-3 me-2 service-nav" id="service-nav" href="./service.html" role="button" >  Services </a>
          ...
          <a class="btn btn-primary px-3 me-2 mqtt-nav" id="mqtt-1-nav"  href="./mqtt.html" role="button"> MQTT-1</a>
            <a class="btn btn-primary px-3 me-2 mqtt-nav" id="mqtt-2-nav" href="./mqtttwo.html" role="button"> MQTT-2</a>
